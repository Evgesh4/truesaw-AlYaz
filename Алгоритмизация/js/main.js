...
window.onload = function () {
    ...
    const SCENE = [
        ...
        sur.sphera(20, 3, new Point(10, Math.sqrt(400 - 100), 0), "#f74b0e", { rotateOz: new Point}), // меркурий 1
         //sur.sphera(20, 4, new Point(-23, Math.sqrt(1600 - 23 * 23), 0), "#6a738b",{ rotateOz: new Point}), // венера 2
         //sur.sphera(20, 4.4, new Point(0, 40, 0), "#2e3dfe", { rotateOz: new Point}), // земля 3
         //sur.sphera(20, 1, new Point(0, 33, 0), "#537d79", { rotateOz: new Point()}), // луна 4
